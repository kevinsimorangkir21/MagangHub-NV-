...
export default function Tentang() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-[#0b0f15] dark:to-[#0b0f15] text-gray-900 dark:text-gray-100 pt-28 pb-24">
      {/* HERO SECTION */}
      <motion.section
      ...
      >
        <div className="p-8 bg-white/70 dark:bg-[#10151d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-md backdrop-blur-xl hover:shadow-blue-500/20 transition">
          <h2 className="text-2xl font-semibold mb-4 text-blue-600">Visi</h2>
        ...
        <div className="p-8 bg-white/70 dark:bg-[#10151d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-md backdrop-blur-xl hover:shadow-blue-500/20 transition">
          <h2 className="text-2xl font-semibold mb-4 text-blue-600">Misi</h2>
